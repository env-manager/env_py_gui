...
################################################################################################
        ...
        ipv4_label = Label(ipv4_frame, text='ipv4 address', font=('Arial', 15), fg='white', bg='black')
        ipv4_label.grid(row=0, column=0, sticky='NSW', padx=20)
        self.ipv4_entry = Entry(ipv4_frame)
        ...
        sub_net_label = Label(sub_net_frame, text='sub_net address', font=('Arial', 15), fg='white', bg='black')
        sub_net_label.grid(row=0, column=0, sticky='NSW', padx=20)
        self.sub_net_entry = Entry(sub_net_frame)
        ...
        gateway_label = Label(gateway_frame, text='gateway address', font=('Arial', 15), fg='white', bg='black')
        gateway_label.grid(row=0, column=0, sticky='NSW', padx=20)
        self.gateway_entry = Entry(gateway_frame)
...
#######################################################################################
        ...
        complete_label = Label(complete_frame, text='Complete', font=('Arial', 17), fg='white', bg='black')
        complete_label.grid(row=0,column=0, sticky='NES')
